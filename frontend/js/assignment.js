...
pages.getAssignments = () => {
    // fetch("https://google-classroom-backend/get_assignment.php")
...
let assignments_array = [{ title: "assignment", due: "23-34 -2023" }, { title: "ehudh", due: "346-30-34" }]
    displayAssignments(assignments_array);
}
